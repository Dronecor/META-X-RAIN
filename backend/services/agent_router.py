...
async def route_and_process(text: str, image_url: str = None) -> str:
    """
    ...
    if image_url:
        ...
        return await visual_search_agent.run_with_image(text, image_url)
